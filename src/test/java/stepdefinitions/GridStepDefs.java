...
driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
    ...
    public void verify_the_page_title_is(String ecpectedTitle) {
String actualTitle= driver.getTitle();
String expectedTitle = ecpectedTitle;
        Assert.assertEquals("Title uyusmadi",actualTitle,expectedTitle);
    }
