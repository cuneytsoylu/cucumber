...
public class WebUniversityStepDefinitions {
    ...
    public void login_portal_a_kadar_asagi_iner() {
      ...
      //  actions.sendKeys(Keys.PAGE_DOWN).perform();
        ...
        jse.executeScript("arguments[0].scrollIntoView(true);",webUniversityPage.webUniversityLoginPortal);
    }

    @Given("Login Portal'a Tiklar")
    public void login_portal_a_tiklar() {
        jse.executeScript("arguments[0].click();",webUniversityPage.webUniversityLoginPortal);
